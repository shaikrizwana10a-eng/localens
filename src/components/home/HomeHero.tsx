...
export const HomeHero: React.FC<HomeHeroProps> = ({
  ...
  return (
    <section className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-[#1C1917] via-[#241E1C] to-[#1B4332] text-white py-12 sm:py-16 px-4 sm:px-8 lg:px-12 border border-stone-800 shadow-xl">
      ...
      <div className="relative z-10 max-w-5xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-3">
          <div className="inline-flex items-center space-x-2 bg-emerald-500/20 border border-emerald-500/40 text-emerald-300 px-3.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider backdrop-blur-md">
            <ShieldCheck className="w-3.5 h-3.5 text-emerald-300" />
            <span>Platform-Verified Ground Truth Travel Knowledge</span>
          </div>
          ...
          <p className="text-emerald-300 font-extrabold text-lg sm:text-xl italic">
        ...
        <div className="bg-white rounded-3xl p-4 sm:p-6 shadow-2xl border border-stone-200 text-stone-900 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-2 relative">
            ...
            <div className="md:col-span-3 bg-[#FAF9F6] p-3 rounded-2xl border border-stone-200 hover:border-[#1B4332] transition-colors relative">
              ...
              <input
                ...
                className="w-full bg-transparent font-black text-stone-900 text-base sm:text-lg focus:outline-none placeholder-stone-400 pt-0.5"
              />
            ...
            <div className="flex items-center justify-center -my-2 md:my-0 md:-mx-3 z-10">
              <button
                ...
                className="w-9 h-9 rounded-full bg-white border border-stone-300 shadow-md hover:border-[#1B4332] text-stone-600 hover:text-[#1B4332] flex items-center justify-center transition-all"
              >
            ...
            <div className="md:col-span-2 bg-[#FAF9F6] p-3 rounded-2xl border border-stone-200">
              ...
              <select
                ...
                className="w-full bg-transparent font-bold text-stone-900 text-xs sm:text-sm focus:outline-none pt-1"
              >
            ...
            <div className="md:col-span-2 flex items-center">
              <button
                ...
                className="w-full h-full min-h-[54px] bg-[#1B4332] hover:bg-[#265e46] active:scale-[0.99] text-white rounded-2xl font-black text-sm shadow-md transition-all flex items-center justify-center space-x-2 px-4"
              >
          ...
          <div className="pt-2 border-t border-stone-100 flex flex-wrap items-center gap-2 text-xs">
            <span className="text-[11px] font-bold text-stone-500 flex items-center mr-1">
              <Navigation className="w-3 h-3 text-[#1B4332] mr-1" />
              Popular Verified Routes:
            </span>
            {popularRoutes.map((r, i) => (
              <button
                ...
                className="bg-[#FAF9F6] hover:bg-emerald-50 text-stone-700 hover:text-[#1B4332] px-2.5 py-1 rounded-lg text-[11px] font-semibold border border-stone-200 transition-colors shadow-2xs"
              >
                {r.label}
              </button>
            ))}
