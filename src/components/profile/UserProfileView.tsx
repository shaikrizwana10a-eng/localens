...
export const UserProfileView: React.FC<UserProfileViewProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="space-y-8 pb-16">
      ...
      <div className="flex flex-col sm:flex-row flex-wrap items-start sm:items-center justify-between gap-2 sm:gap-3 px-1 text-xs">
      ...
      <div className="flex items-center space-x-1.5 overflow-x-auto pb-1 scrollbar-none border-b border-[#E7E5E4]">
        {tabs.map((tab) => (
          <button
            ...
            className={`px-3 sm:px-4 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center space-x-2 shrink-0 border mobile-touch-target ${
              activeTab === tab.id
