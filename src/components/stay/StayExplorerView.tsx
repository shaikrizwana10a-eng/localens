...
export const StayExplorerView: React.FC<StayExplorerViewProps> = ({ stays, onNavigate }) => {
  ...
  return (
    <div className="space-y-10 pb-16">
      ...
      {/* Filter Bar */}
      <div className="bg-white p-3 sm:p-4 lg:p-5 rounded-2xl border border-stone-200 shadow-xs flex flex-col sm:flex-row sm:flex-wrap items-start sm:items-center justify-between gap-3 sm:gap-4 text-xs">
          ...
          <div className="flex items-center space-x-1 overflow-x-auto scrollbar-none pb-1">
            {['ALL', 'Budget Hotel', 'Homestay', 'Dharamshala', 'Boutique Stay'].map((cat) => (
              <button
                ...
                className={`px-3 py-2 sm:py-1 rounded-lg font-bold transition-all cursor-pointer whitespace-nowrap mobile-touch-target ${
                  categoryFilter === cat
